...
const uint16_t sine_table_one_quadrant[128]={512,518,524,530,537,543,549,555,562,568,574,580,587,593,599,605,611,617,624,630,636,642,648,654,660,666,672,678,684,690,696,701,707,713,719,725,730,736,741,747,753,758,764,769,774,780,785,790,796,801,806,811,816,821,826,831,836,841,846,850,855,860,864,869,873,878,882,886,890,895,899,903,907,911,915,919,922,926,930,933,937,940,944,947,950,953,957,960,963,966,968,971,974,977,979,982,984,986,989,991,993,995,997,999,1001,1003,1004,1006,1008,1009,1011,1012,1013,1014,1015,1017,1017,1018,1019,1020,1021,1021,1022,1022,1022,1023,1023,1023};
const uint16_t tri_table_one_quadrant[128]={512,516,520,524,528,532,536,540,544,548,552,556,560,564,568,572,576,580,584,588,592,596,600,604,608,612,616,620,624,628,632,636,640,644,648,652,656,660,664,668,672,676,680,684,688,692,696,700,704,708,712,716,720,724,728,732,736,740,744,748,752,756,760,764,768,772,776,780,784,788,792,796,800,804,808,812,816,820,824,828,832,836,840,844,848,852,856,860,864,868,872,876,880,884,888,892,896,900,904,908,912,916,920,924,928,932,936,940,944,948,952,956,960,964,968,972,976,980,984,988,992,996,1000,1004,1008,1012,1016,1020};
const uint8_t A2D_lookup[3]={0b100,0b101,0b110};
# 62 "main.c"
uint16_t duty;
uint8_t current_waveshape;
uint16_t current_speed_linear;
uint16_t current_speed_log;
...
uint16_t DO_ADC(uint8_t modifier){
    ...
    ADCON0 = ADCON0 | A2D_lookup[modifier];
        ADON = 1;
        GO_nDONE = 1;
        while(GO_nDONE == 1){}
        ADON = 0;
...
void CONVERT_SPEED_TO_LOG(uint16_t *linear_speed, uint16_t *log_speed){
    ...
    uint16_t temp = 341*log10f(*linear_speed);
    *log_speed = temp & 0b0000001111111111;

}
}

void SET_DUTY_CCP3(uint16_t *duty_ptr){

    CCPR3L = *duty_ptr / 0b100;
    int temp = *duty_ptr % 0b100;
...
void main(void) {
    ...
    CONFIG_PWM_CCP3();
        ...
        current_speed_linear = DO_ADC(1);
        current_depth = DO_ADC(2);

        CONVERT_SPEED_TO_LOG(&current_speed_linear, &current_speed_log);
